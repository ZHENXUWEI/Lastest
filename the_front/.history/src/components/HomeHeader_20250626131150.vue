...
const fetchUsers = async () => {
  window.location.href = `https://idm.hzsteel.com/ssoserver/moc2/authorize?responese_type=code&client_id=zcfw&redirect_uri=http://localhost:5173/callback&state=1`;
  //   console.log("确实进来了");
...
onMounted(async () => {
  ...
  if (code) {
    console.log("收到 OAuth2 code:", code);
  }
...
<template>
  ...
  <div id="header">
    <div class="nav">
      <img
        src="https://en.hzsteel.com/res/cms/www/index/images/logo.png"
        alt=""
      />
