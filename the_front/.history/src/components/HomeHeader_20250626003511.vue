...
const fetchUsers = async () => {
    window.location.href=`https://idm.hzsteel.com/ssoserver/moc2/authorize?responese_type=code&client_id=zcfw&redirect_uri=http://localhost:5173/callback&state=`
//   console.log("确实进来了");
