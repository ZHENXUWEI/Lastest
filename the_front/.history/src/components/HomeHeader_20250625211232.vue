...
<template>
    ...
    <div id="header" >
        <div class="nav">
            <img src="https://en.hzsteel.com/res/cms/www/index/images/logo.png" alt="">
            ...
            <div class="nav_span">
                ...
                style="cursor: pointer;margin-left:5vw"><RouterLink class="rl " to="/" >首页</RouterLink> </span>
                <span 
                :class="{active:activeIndex === 1}"
                
                style="cursor: pointer;"><RouterLink class="rl" to="/policy" >政策查询</RouterLink></span>
                <span 
                :class="{active: activeIndex === 2 }"
                 
                style="cursor: pointer;"><RouterLink  class="rl" to="/match" >政策匹配</RouterLink></span>
            </div>
       </div>
        ...
        <div class="user">
            ...
            <span class="suxian"></span>
            <span class="loginout" @click="loginOut" style="margin-right: 2vw;cursor:pointer">退出登录</span>
            
            </div>
            
            <el-button style="margin-right: 2vw;" @click="fetchUsers" v-else >登录</el-button>
        </div>
    </div>
