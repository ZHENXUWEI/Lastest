...
const fetchUsers = async () => {
  window.location.href = `https://https://172.18.30.42/ssoserver/moc2/authorize?responese_type=code&client_id=zcfw&redirect_uri=http://localhost:5173/callback&state=1`;
  //   console.log("确实进来了");
