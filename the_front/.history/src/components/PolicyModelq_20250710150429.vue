      ...
      <div class="policy_left">
        ...
        >
          ...
          <div class="el_card_bottom">
            ...
            <span style="cursor: pointer" @click="showMore(item)"
              >查看更多></span
            >
          </div>
        </div>
        ...
        >
          ...
          <div class="el_card_bottom">
            <span>
              ...
              >
              <font class="suxian">|</font>
              <font class="shenbao">{{ isShenBao(item.history) }}</font> </span
            ><span style="cursor: pointer" @click="showMore(item)"
              >查看更多></span
            >
          </div>
    ...
    <div class="main_center">
      <div class="modelName_div">
        ...
        <div class="caozuo">
          ...
          <span
            class="shenbao"
            @click="toSumbMaterialFun(ZT.split('/')[0])"
            style="
              margin-left: 0.3vw;
              background: linear-gradient(45deg, #1fb456, #35c97f);
            "
      ...
      <div class="upload">
        <p>
          您的政策状态为:<span style="margin-left: 0.5vw">
            <font
              class="dabiao"
              :class="{ activedabiao: ZT.split('/')[0] == '未达标' }"
            >
              {{ ZT.split("/")[0] }}
            </font>
            <font class="suxian">/</font>
            <font
              class="shenbao"
              :class="{ activeshenbao: ZT.split('/')[1] == '历史已申报' }"
            >
              {{ ZT.split("/")[1] }}
            </font>
          </span>
        ...
        <p v-if="DaBiaoStr">
          该政策模型期望的指标条件:<span
            style="color: red; margin-left: 0.5vw"
            >{{ DaBiaoStr }}</span
          >
        </p>
        <p v-if="QiYeStr">
          ...
          <div style="height: 20vw">
            <el-scrollbar>
              <div style="height: 100%">
                <el-row :gutter="20" v-for="item in unqualDate" :key="item">
                  <!-- gutter 是列与列之间的间距 -->
                  <el-col :span="12">
                    <!-- 占据 50% 的宽度 -->
                    <h5>{{ item.name }}</h5>
