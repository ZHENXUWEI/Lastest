...
import { loginAPI, sso } from "@/api/user";
import {
  policyinfoAPI,
  policystatusAPI,
  policyVisitNAPI,
...
const selectFun = async (data) => {
  ...
  const res = await policyinfoAPI({
    type: 1,
    policyType: data,
    subPolicyType: areaName,
  });
...
<template>
  <div id="main">
    ...
    <div id="nav">
      <div class="nav_span">
        <span style="cursor: pointer; margin-left: 11.2vw"
          ><RouterLink class="rl" to="/">首页</RouterLink>
        </span>
        <span style="cursor: pointer"
          ><RouterLink class="rl" to="/policy">政策库</RouterLink></span
        >
        <span style="cursor: pointer"
      ...
      <el-button
        @click="fetchUsers"
        v-else
        style="margin-right: 4vw; font-size: 1vw; width: 3vw; height: 2vw"
        >登录</el-button
      >
    </div>
    ...
    <div id="policyOverview">
      <div class="policyOverview_show">
        ...
        <div style="padding-left: 10px">
          <p>
            <font color="orange">{{ policyStatus.policyN }}万</font>条
          </p>
          <p>政策库</p>
        </div>
      </div>
      ...
      <div class="policyOverview_show">
        ...
        <div style="padding-left: 10px">
          <p>
            <font color="orange">{{ policyStatus.companyN }}</font
            >个
          </p>
          <p>企业用户</p>
        </div>
      ...
      <div class="policyOverview_show">
        ...
        <div style="padding-left: 10px">
          <p>
            <font color="orange">{{ policyStatus.matchN }}次</font>条
          </p>
          <p>政策智能匹配</p>
        </div>
      </div>
      ...
      <div class="policyOverview_show">
        <img
          src="../assets/images/icon5.jpg"
          class="policyOverview_img"
          alt=""
        />
        <div style="padding-left: 10px">
          <p>
            <font color="orange">{{ policyStatus.declarationN }}</font
            >次
          </p>
          <p>企业申报数量</p>
        </div>
          ...
          <span>
            <font color="grey"
              ><RouterLink
                class="rl"
                to="/policy"
                style="font-size: 2.5vh; cursor: pointer"
                >更多>></RouterLink
              ></font
            >
          </span>
      ...
      <div style="width: 100%">
        ...
        >
          ...
          <div
            ...
            "
          >
            <el-tag style="padding: 0 20px" type="danger">{{
              timeStatusFun(item.deadTime)
            }}</el-tag>
            <el-tag style="padding: 0 20px; margin-left: 3vh" type="info">{{
    ...
    <div id="hotpolicy">
      <h3>热门项目申报</h3>
      <p style="color: grey; font-size: 1vw; padding: 1vw 0 1vw 2vw">
        海量项目申报查询 &nbsp;&nbsp;&nbsp;&nbsp; 一对一政策精准自评
      </p>
